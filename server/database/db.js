...
const Connection = async (username, password) => {
    const URL = `mongodb://user:user@ac-iqcgdye-shard-00-00.cevtipt.mongodb.net:27017,ac-iqcgdye-shard-00-01.cevtipt.mongodb.net:27017,ac-iqcgdye-shard-00-02.cevtipt.mongodb.net:27017/?ssl=true&replicaSet=atlas-kk5aw8-shard-0&authSource=admin&retryWrites=true&w=majority`;
